...
export type CertSnapshot = {
  employee: { name: string; email: string; department: string | null; position: string | null; hire_date: string | null; resign_date: string | null; birth_date: string | null; employment_status: string };
  company: { company_name: string; brand_name: string; ceo_name: string; biz_no: string; address: string; phone: string; issuer_title: string };
