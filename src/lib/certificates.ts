...
export type CertSnapshot = {
  employee: { name: string; email: string; department: string | null; position: string | null; hire_date: string | null; resign_date: string | null; birth_date: string | null; address?: string | null; duties?: string | null; employment_status: string };
